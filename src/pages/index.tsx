...
export const getStaticProps = async () => {
  ...
  const topRes = await fetch(
    `https://newsapi.org/v2/top-headlines?country=jp&pageSize=${pageSize}&apiKey=ecc7438e30fc43f5ac005077af964a0c`
  );
  ...
  const weatherRes = await fetch(
    `https://api.openweathermap.org/data/2.5/onecall?lat=${lat}&lon=${lon}&units=metric&exclude=${exclude}&appid=aa17b7d3fe7e8b66c3983cad025ad67d`
  );
  ...
  const pickupRes = await fetch(
    `https://newsapi.org/v2/everything?q=${keyword}&language=jp&sortBy=${sortBy}&pageSize=${pickupPageSize}&apiKey=ecc7438e30fc43f5ac005077af964a0c`
  );
